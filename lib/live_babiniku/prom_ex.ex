defmodule LiveBabiniku.PromEx do
  @moduledoc """
  ...
  1. Update your configuration (config.exs, dev.exs, prod.exs, releases.exs, etc) to
     ...
     ```
     config :live_babiniku, LiveBabiniku.PromEx,
       disabled: false,
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule LiveBabinikuWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :live_babiniku

       ...

       plug PromEx.Plug, prom_ex_module: LiveBabiniku.PromEx
  ...
  use PromEx, otp_app: :live_babiniku
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: LiveBabinikuWeb.Router, endpoint: LiveBabinikuWeb.Endpoint},
      # Plugins.Ecto,
      # Plugins.Oban,
      ...
      # LiveBabiniku.Users.PromExPlugin
    ]
  end
  ...
  def dashboards do
    [
      ...
      # {:live_babiniku, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
